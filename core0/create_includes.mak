...
ifdef CONFIG_GLIBC
	...
	$(RG_CP_LN) $(TOOLS_PREFIX)/$(TARGET_MACHINE)/lib/* $(RG_LIB)
	$(RG_CP_LN) $(TOOLS_PREFIX)/$(TARGET_MACHINE)/include/* $(RG_BUILD)/glibc/include
    endif
endif
ifdef CONFIG_ULIBC
    ...
    ifeq ($(ULIBC_IN_TOOLCHAIN),y)
        # this is done in ulibc/Makefile for non-toolchain ulibc
	$(RG_CP_LN) $(TOOLS_PREFIX)/$(TARGET_MACHINE)/lib/* $(RG_LIB)
	$(RG_CP_LN) $(TOOLS_PREFIX)/$(TARGET_MACHINE)/include/* $(RG_BUILD)/ulibc/include
    else
