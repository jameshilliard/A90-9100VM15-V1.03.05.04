...
#define	CPU1_RAM_PHYADDR_END		0x04000000		//CPU1 occupies the 2nd 16MB, so before that, is for CPU0
#endif
//prochao-
...
#ifdef CONFIG_INFINEON_PPE_D4_11N
//prochao+, 09-03-2007
void ifx_mps_relinguish_core1_buffers(void);
//prochao-
#endif
/* CPU 1 ] */
