...
/* defines for ioctl's */
/***********************/
#define WESTELL_SSC_IOCTL_MAGIC     'S'
/* read out the statistics */
#define WESTELL_SSC_BAUD_SET _IOW(WESTELL_SSC_IOCTL_MAGIC, 3, unsigned int)
/* get the current baudrate */
#define WESTELL_SSC_BAUD_GET _IOR(WESTELL_SSC_IOCTL_MAGIC, 4, unsigned int)
/* set hardware options */
#define WESTELL_SSC_HWOPTS_SET _IOW(WESTELL_SSC_IOCTL_MAGIC, 5, struct ifx_ssc_hwopts)
/* get the current hardware options */
#define WESTELL_SSC_HWOPTS_GET _IOR(WESTELL_SSC_IOCTL_MAGIC, 6, struct ifx_ssc_hwopts)
/* set transmission mode */
#define WESTELL_SSC_RXTX_MODE_SET _IOW(WESTELL_SSC_IOCTL_MAGIC, 7, unsigned int)
/* get the current transmission mode */
#define WESTELL_SSC_RXTX_MODE_GET _IOR(WESTELL_SSC_IOCTL_MAGIC, 8, unsigned int)
/* abort transmission */
#define WESTELL_SSC_ABORT _IO(WESTELL_SSC_IOCTL_MAGIC, 9)
#define WESTELL_SSC_FIFO_FLUSH _IO(WESTELL_SSC_IOCTL_MAGIC, 9)

/* set general purpose outputs */

//#define IFX_SSC_GPO_OUT_CLR _IOW(WESTELL_SSC_IOCTL_MAGIC, 33, unsigned int)
/* get general purpose outputs */
//#define IFX_SSC_GPO_OUT_GET _IOR(WESTELL_SSC_IOCTL_MAGIC, 34, unsigned int)

/*** serial framing ***/
/* get status of serial framing */
//#define IFX_SSC_FRM_STATUS_GET _IOR(WESTELL_SSC_IOCTL_MAGIC, 48, struct ifx_ssc_frm_status)
/* get counter reload values and control bits */
//#define IFX_SSC_FRM_CONTROL_GET _IOR(WESTELL_SSC_IOCTL_MAGIC, 49, struct ifx_ssc_frm_opts)
/* set counter reload values and control bits */
//#define IFX_SSC_FRM_CONTROL_SET _IOW(WESTELL_SSC_IOCTL_MAGIC, 50, struct ifx_ssc_frm_opts)


/*** batch execution ***/
/* do batch execution */
//#define IFX_SSC_BATCH_EXEC _IOW(WESTELL_SSC_IOCTL_MAGIC, 64, struct ifx_ssc_batch_list)
