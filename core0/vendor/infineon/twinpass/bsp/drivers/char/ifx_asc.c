...
/* FIXME:It's not good idea to use #if defined here */
...
#define IFX_ASC1_TIR           INT_NUM_IM1_IRL0  /* TX interrupt */
#define IFX_ASC1_TBIR          INT_NUM_IM1_IRL1  /* TX buffer interrupt */
#define IFX_ASC1_RIR           INT_NUM_IM1_IRL2  /* RX interrupt */
#define IFX_ASC1_EIR           INT_NUM_IM1_IRL3  /* ERROR interrupt */
//prochao+-
#else
...
#else
//prochao+, assuming CPU0 uses ASC1 and CPU0 uses ASC0 on the TwinPass-E board (Danube code for developing)
#if	1
#if	defined(CONFIG_DANUBE_CORE1)||defined(CONFIG_TWINPASS_E_CORE1)		//for the dual-core
#define IFX_ASC1_INCLUDED
#else
...
//TODO:
  ...
  *DANUBE_GPIO_P0_PUDSEL |= ((1<<10) | (1<<11));
  *DANUBE_GPIO_P0_PUDEN |= ((1<<10) | (1<<11));
  /* Set CLC register*/
