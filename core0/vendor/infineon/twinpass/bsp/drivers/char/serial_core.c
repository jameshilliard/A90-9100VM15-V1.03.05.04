 ...
 *
 *  $Id: serial_core.c,v 1.1.2.1 2006/09/22 02:34:23 igor Exp $
 *
 */
...
#if 0 /* [ Commented out by Liu Peng */
	info->xmit.head = info->xmit.tail = 0;
#endif /* ] */
...
static int uart_get_modem_info(struct uart_info *info, unsigned int *value)
{
	...
	result &= TIOCM_DTR|TIOCM_RTS|TIOCM_OUT1|TIOCM_OUT2;
...
extern void at91us3_rs_console_init(void);
extern void s3c2800uart_console_init(void);
extern void mx1ads_console_init(void);
extern void incaipasc_console_init(void);
extern void ifx_asc_console_init(void);
...
void __init uart_console_init(void)
{
	...
	at91us3_rs_console_init();
#endif
#ifdef CONFIG_SERIAL_S3C2800_CONSOLE
	s3c2800uart_console_init();
#endif
#ifdef CONFIG_SERIAL_MX1ADS_CONSOLE
	mx1ads_console_init();
#endif
#ifdef CONFIG_SERIAL_AMAZONASC_CONSOLE
        amazonasc_console_init();
#endif
#ifdef CONFIG_SERIAL_INCAIPASC_CONSOLE
	incaipasc_console_init();
#endif
#ifdef CONFIG_SERIAL_IFX_ASC_CONSOLE
	ifx_asc_console_init();
#endif  
}
