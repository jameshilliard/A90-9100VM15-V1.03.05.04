...
extern int __init ifxdeu_init_des(void);
#endif
#ifdef CONFIG_CRYPTO_DEV_DANUBE_AES
extern int __init ifxdeu_init_aes(void);
#endif
#ifdef CONFIG_CRYPTO_DEV_DANUBE_MD5
extern int __init ifxdeu_init_md5(void);
#endif
#ifdef CONFIG_CRYPTO_DEV_DANUBE_SHA1
extern int __init ifxdeu_init_sha1(void);
#endif
