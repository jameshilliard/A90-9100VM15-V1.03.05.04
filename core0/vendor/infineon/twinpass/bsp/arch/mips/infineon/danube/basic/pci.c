...
#undef DANUBE_PCI_TEST

#define WESTELL_CPLD_REGISTER             ((volatile u16*)0xb4a00000)
...
static void __init danube_pci_startup(void)
{
...
#ifndef CONFIG_WESTELL_ULTRALINE3
  ...
  *DANUBE_GPIO_P1_OUT = *DANUBE_GPIO_P1_OUT | ((0x20));
  ...
  // winder add, 20061201, mask pci request1, request2 and request3.
  temp_buffer |= 0xe0000;
  ...
  /* base: 0x0 ==> 0x0 */
  /* size: 32M */
  /* BAR1 128M map to SDR address */
  DANUBE_PCI_REG32(PCI_CR_BAR11MASK_REG) = 0x08000008;
...
#ifdef WESTELL_WIRELESS_ONBOARD
  *WESTELL_CPLD_REGISTER |= 0x80;
#endif
