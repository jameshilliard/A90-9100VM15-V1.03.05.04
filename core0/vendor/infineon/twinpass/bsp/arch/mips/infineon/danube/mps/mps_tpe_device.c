...
// prochao-
#include <vendor/infineon/twinpass/rg_modules/uImage_load_params.h>
...
u32	*mps_tpe_cpu1_entry_base = PARAM_IH_EP;	//where keeping the trigger point
...
//	add_timer(&mps_timer);
	mod_timer(&mps_timer, jiffies + HZ/10);	//every 0.1s
	//
#else	//original one
	mps_RxCmdQ.msg_callback_flag = 1;
