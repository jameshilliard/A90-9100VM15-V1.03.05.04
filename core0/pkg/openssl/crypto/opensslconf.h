 ...
 * 
 *  rg/pkg/openssl/crypto/opensslconf.h
 *
...
#endif
#if !defined(CONFIG_RG_OPENSSL_BLOWFISH) && !defined(OPENSSL_NO_BF)
# define OPENSSL_NO_BF
#endif
#if !defined(CONFIG_RG_OPENSSL_CAST) && !defined(OPENSSL_NO_CAST)
