...
#include <rg_version_data.h> //WESTELL change, use this instead of rg_version.h
...
static int is_feature_enabled(char *feature_name)
{
	...
	{FEATURE_MAIL_SERVER, "CONFIG_RG_MAIL_SERVER"},
	{FEATURE_ZERO_CONFIG_NET, "MODULE_RG_ZERO_CONFIGURATION_NETWORKING"},
	{FEATURE_WEB_SERVER, "CONFIG_RG_WEB_SERVER"},
	{FEATURE_FTP_SERVER, "CONFIG_RG_FTP_SERVER"},
	{FEATURE_FS_BACKUP, "CONFIG_RG_FS_BACKUP"},
	{FEATURE_RAID, "CONFIG_RG_RAID"},
	...
	{FEATURE_TR_098, "MODULE_RG_TR_098"},
	{-1}
    };

    if (no_lic)
	return 1;
    feature_id = str2code(modules, feature_name);
    if (feature_id < 0)
...
static int token_set_by_cmdline(char *token)
{
    option_t *o;
