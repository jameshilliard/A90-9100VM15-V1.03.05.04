 ...
 *
 * $Id: ipsec_alg.h,v 1.1.220.1 2006/07/18 09:56:52 sergey Exp $
 *
 */
/*
...
struct ipsec_alg_auth {
	...
	__u8 *(*ixt_a_hmac_new_key)(struct ipsec_alg_auth *alg, const __u8 *key, int keylen);
	void (*ixt_a_hmac_destroy_key)(struct ipsec_alg_auth *alg, __u8 *key_a);
