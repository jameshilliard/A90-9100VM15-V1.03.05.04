...
BOOK=\\BOOKfalse
SIZE=\\SIZEFORAFIVEfalse

ifdef CONFIG_A5B
  BOOK=\\BOOKtrue
  SIZE=\\SIZEFORAFIVEtrue
endif
...
CREATE_IFDEFS_FILE=$(shell echo "%% This is an auto-generated file by docs.mak" > $(IFDEFS_FILE)) $(shell echo $1 >> $(IFDEFS_FILE)) $(shell echo $2 >> $(IFDEFS_FILE)) $(shell echo $(LSP_TYPE) >> $(IFDEFS_FILE)) $(shell echo $(TUTORIAL) >> $(IFDEFS_FILE)) $(shell echo $(BOOK) >> $(IFDEFS_FILE)) $(shell echo $(SIZE) >> $(IFDEFS_FILE))
