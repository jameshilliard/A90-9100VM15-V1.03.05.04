...
_GET_OBJ_CFLAGS=$(call DBGFR,\
  ...
  $(TARGET_CFLAGS_$(call FIX_OBJ_NAME,$2)) $(CFLAGS_$(call FIX_OBJ_NAME,$2))\
...
ifeq ($(CONFIG_RG_JPKG_SRC)-$(CONFIG_RG_LANG),-y)
...
archconfig:: $(ARCHCONFIG_FIRST_TASKS) \
    ...
    $(ARCHCONFIG_SUBDIRS_) $(ARCHCONFIG_LAST_TASKS)
...
ALL_CLEAN_FILES+=$(foreach t,$(TARGET) $(SO_TARGET) $(MOD_TARGET),$(DEBUG_PATH)/$t)
