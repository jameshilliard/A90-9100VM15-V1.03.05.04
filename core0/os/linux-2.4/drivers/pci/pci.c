/*
 *	$Id: pci.c,v 1.5.64.1 2006/10/21 02:23:54 alex Exp $
 *
...
//RLQ
/**
 * pci_set_mwi - enables memory write invalid feature
 * @dev: the PCI device to enable
 *
 * Enables memory write invalid on the device to do the needed arch specific settings.
 */
/*
void
pci_set_mwi(struct pci_dev *dev)
{
	...
	if (! (cmd & PCI_COMMAND_INVALIDATE)) {
		DBG("PCI: Enabling PCI memory write invalid for device %s\n", dev->slot_name);
