/* -*- linux-c -*-
 *
 *	$Id: sysrq.c,v 1.7.228.1 2006/09/25 19:06:33 igor Exp $
 *
...
#if defined CONFIG_KGDB || defined CONFIG_REMOTE_DEBUG || \
	defined CONFIG_X86_REMOTE_DEBUG
static void 
sysrq_handle_kgdb(int key, struct pt_regs *regs, struct kbd_struct *unused0,
		struct tty_struct *unused1)
{
	breakpoint();
}

static struct sysrq_key_op sysrq_kgdb_op = {
	handler: sysrq_handle_kgdb,
	help_msg: "Debug Break",
	action_msg: "Breaking into KGDB"
};
#endif
