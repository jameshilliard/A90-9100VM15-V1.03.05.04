...
void __init setup_arch(char **cmdline_p)
{
	...
	void danube_setup(void);
	void incaip_setup(void);
	...
	case MACH_GROUP_SIBYTE:
		...
		break;
#endif
#if defined(CONFIG_DANUBE) || defined(CONFIG_TWINPASS)
        case MACH_GROUP_DANUBE:
        case MACH_GROUP_TWINPASS:
                danube_setup();
                break;
#endif
#ifdef CONFIG_INCAIP
        case MACH_GROUP_INCAIP:
                incaip_setup();
                break;
#endif
