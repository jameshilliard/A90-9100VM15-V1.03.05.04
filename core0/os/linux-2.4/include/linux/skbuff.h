...
#ifdef CONFIG_TWINPASS_DUALCORE_WLAN_FEATURE
	/* core1 compatability */
...
#if defined(CONFIG_NETFILTER) || defined(CONFIG_OPENRG)
...
#endif
#endif /*CONFIG_NETFILTER || CONFIG_OPENRG*/
	struct dyn_field_t	*fp_flow_info;  /* fast path flow information */

#ifdef CONFIG_WSTL_SAVE_RXDEV
    struct net_device	*rx_dev;	/* Original RX device */
#endif
...
#if defined(CONFIG_NET_SCHED) || defined(CONFIG_OPENRG)
