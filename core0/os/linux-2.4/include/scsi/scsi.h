...
/*
    $Header: /arch/cvs/rg/os/linux-2.4/include/scsi/scsi.h,v 1.5 2003/09/21 20:22:16 igork Exp $
...
/* Used to get the vendor and model of a device */
#define SCSI_IOCTL_GET_MODEL 0x5388

/*Used to get the device serial number*/
#define SCSI_IOCTL_GET_GUID 0x5389

#define SCSI_IOCTL_GET_GUID_BUFFER_LEN 64 //min size of buffer used for SCSI_IOCTL_GET_GUID

/* Used to get the vendor and model of a device */
struct scsi_vendor_model
{
	char vendor[9], model[17], rev[5], host[64];
};
