...
#define ADI_6680_SERIAL_PORT_DEFNS { 0, 100000000 / 16, 0, 6, STD_COM_FLAGS, 0, SERIAL_IO_MEM, 0, 0, 0, 0, 0, (char *)0xb9020000, 2, io_type: SERIAL_IO_MEM },
#else
#define ADI_6680_SERIAL_PORT_DEFNS
#endif

#ifdef CONFIG_ADI_6843
#define ADI_6843_SERIAL_PORT_DEFNS \
    { type: PORT_16550A, \
      baud_base: 100000000 / 16, irq: 6, flags: STD_COM_FLAGS, \
      iomem_base: (u8*)0xb9020000, iomem_reg_shift: 2, \
      io_type: SERIAL_IO_MEM},
#else
#define ADI_6843_SERIAL_PORT_DEFNS
#endif
...
#define SERIAL_PORT_DFNS			\
	...
	DDB5477_SERIAL_PORT_DEFNS		\
        ADI_6680_SERIAL_PORT_DEFNS      	\
        ADI_6843_SERIAL_PORT_DEFNS
